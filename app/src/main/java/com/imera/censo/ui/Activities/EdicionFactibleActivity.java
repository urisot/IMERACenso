...
import com.imera.censo.ui.Fragments.CapturaFactible1Fragment;
import com.imera.censo.ui.Fragments.CapturaFactible2Fragment;
import com.imera.censo.ui.Fragments.CapturaFactible3Fragment;
...
public class EdicionFactibleActivity extends AppCompatActivity implements InterfaceTiposWizard {
    ...
    //acual segun sea el caso...

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edicion_factible);
        ...
        adapter = new MiFragmentStatePagerAdapter(getSupportFragmentManager(), 3, new MiFragmentStatePagerAdapter.enCambioFragmento() {
            ...
            public Fragment cambioFragment(int position) {
                ...
                switch (position){
                    case 0:
                        fragmento = new CapturaFactible1Fragment();
                        fragmento.setArguments(argumentos);
                        break;
                    case 1:
                        fragmento = new CapturaFactible2Fragment();
                        fragmento.setArguments(argumentos);
                        break;
                    case 2:
                        fragmento = new CapturaFactible3Fragment();
                        fragmento.setArguments(argumentos);
                        break;
                }
                return fragmento;
